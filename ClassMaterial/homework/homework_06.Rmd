...
In order to have more practice problems for the midterm exam, please create a practice problem that seems appropriate to you. Once you have created the problem, post it to Canvas under the section on "Midterm practice", and also write your practice problem below. You can the use questions others wrote as practice for the exam. Provided a few good questions are posted, I will use one of them on the actual exam.
