...
In the following homework you will gain practice running hypothesis tests for two means. Please submit a compiled pdf with your answers to the exercises to Gradescope *by 11:30pm on Sunday March 21st*.  This homework has intentionally been kept short (out of 50 points total) since you have a little less time to work on it then a typical homework and also to give you more time to study for the midterm exam. 

A list of functions we have used in class can be found on [Canvas](https://yale.instructure.com/courses/65108/pages/r-functions-used-in-the-class).  You might also find the following symbols useful:  $\mu$,  $H_0$, $H_a$, $\mu_{sleep}$, $\bar{x}_{control}$,  $\ne$, $\alpha$, $H_0$  and $H_a$. For full credit on problems involving R, be sure to label all your figures and to "show your work" by making sure all values that are answers to questions are printed/visible in your R Markdown pdf.
...
Please reflect on how the homework went by going to Canvas, going to the Quizzes link, and clicking on [Reflection on homework 6](https://yale.instructure.com/courses/65108/quizzes/35117).
