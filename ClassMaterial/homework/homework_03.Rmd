...
a. Using the symbols discussed in class, give notation (i.e,. two symbols separated by a minus sign) for the quantity we would ideally like to know.

b. Again using the symbols discussed in class, give notation (i.e,. two symbols separated by a minus sign) for the quantity that gives our best estimate of the ideal quantity based on the data collected.
...
Please reflect on how the homework went by going to Canvas, going to the Quizzes link, and clicking on [Reflection on homework 3](https://yale.instructure.com/courses/84843/quizzes/58670).
