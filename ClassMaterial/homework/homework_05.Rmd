...
In the following homework, you will gain practice with hypothesis tests for a single proportion. Please submit a compiled pdf with your answers to the exercises to Gradescope *by 11:30pm on Tuesday March 16th*. Note, this is the only homework that will be due on a Tuesday rather than a Sunday! 
...
download.file("https://raw.githubusercontent.com/emeyers/SDS100/master/ClassMaterial/images/Lock5_4_15.png", "Lock5_4_15.png", mode = "wb")

download.file("https://raw.githubusercontent.com/emeyers/SDS100/master/ClassMaterial/images/Lock5_4_19.png", "Lock5_4_19.png", mode = "wb") 
  
download.file("https://raw.githubusercontent.com/emeyers/SDS100/master/ClassMaterial/images/Paul_The_Octopus.jpg", "Paul_The_Octopus.jpg", mode = "wb") 
...
**Exercise 1.2 (9 points)**: Suppose we wanted to test whether the average body temperature of beavers was greater than 37.6 degrees Celsius.  Please state what the population parameter of interest is, and state the null and alternative hypotheses using both words and symbols. 
...
c.	Below a plot of a null distribution for this test. Use the fact that there are 1000 points in this distribution to find the p-value. Explain your reasoning. 
...
**Exercise 2.1 (4 points)**: Start by writing down the 5 steps for hypothesis testing. You can look at the lecture slides if you need to, although you should memorize these steps sometime soon.
...
**Exercise 2.7 (15 points)**: Calculate the confidence interval for Paul's prediction abilities using the bootstrap method.
...
Please reflect on how the homework went by going to Canvas, going to the Quizzes link, and clicking on [Reflection on homework 5](https://yale.instructure.com/courses/65108/quizzes/35116).
